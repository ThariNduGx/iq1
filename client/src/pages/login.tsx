          ...
          <Card className="border-0 shadow-xl bg-white/90 backdrop-blur">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-center text-gray-500 mt-2 text-base">
                {isDemoMode 
                  ? "Experience the dashboard features in demo mode" 
            ...
            <CardContent className="space-y-6 px-8">
              ...
              {isDemoMode && (
                <>
                  <Button
                    className="w-full py-6 text-base flex items-center justify-center gap-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white transition-all shadow-md hover:shadow-lg"
                  ...
                  >
                    ...
                    <span className="font-medium">Explore Demo Dashboard</span>
                  </Button>
                  ...
                  <div className="p-4 bg-amber-50 border border-amber-200 rounded-md">
                    <p className="text-sm text-amber-800 flex items-start">
                      ...
                      <span>Demo mode is active because Google OAuth credentials aren't configured. Data is simulated for demonstration purposes.</span>
                    </p>
                  </div>
                </>
              )}
